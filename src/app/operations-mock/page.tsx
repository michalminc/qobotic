    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-black/[0.06]">
      <div className="max-w-[1280px] mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          {["Platform", "Interface", "Deployment", "Infrastructure", "Team"].map((item) => (
  ...
  return (
    <footer className="bg-[#f5f5f7] border-t border-black/[0.06] py-10 px-6">
      <div className="max-w-[1280px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <span className="text-[12px] text-[#86868b]">© 2025 Qobots. Operations Platform mock.</span>
        <div className="flex items-center gap-6">
          <Link href="/mock" className="text-[12px] text-[#86868b] hover:text-[#1d1d1f] transition-colors">← Home mock</Link>
          <Link href="/intelligence-mock" className="text-[12px] text-[#86868b] hover:text-[#1d1d1f] transition-colors">Intelligence mock</Link>
        </div>
      </div>
    </footer>
  );
